...
interface FooterLink {
  label: string;
  subLinks?: SubLabelDetails[];
}

interface SubLabelDetails {
  subLabel: string;
  subLink: string;
}
...
const Footer = (props: Props) => {
  return (
    <footer className={`bg-gray-200 dark:bg-gray-800 pt-4 pb-8 xl:pt-8`}>
      <div className="max-w-screen-lg px-4 mx-auto text-gray-700 xl:max-w-screen-xl sm:px-6 md:px-8 dark:text-gray-300">
